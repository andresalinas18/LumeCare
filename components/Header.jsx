...
export default function Header() {
  ...
  return (
    <header
      id="home"
      className="fixed top-[15px] left-[15px] right-[15px] z-[100] bg-white border border-white/20 rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.1)] backdrop-blur-[12px]"
    >
      <nav className="relative flex items-center h-[80px] px-6 justify-between">
        ...
        <div className="flex items-center">
          <a
            href="#home"
            aria-label="LumeCare - Go to homepage"
            className="block h-full max-h-[4.5rem]"
          >
            <Image
              src={LumeCareLogo}
          ...
          <ul className="flex items-center gap-[2.5rem] list-none m-0 p-0">
            <li>
              <a
                ...
                className="text-text text-base font-normal transition-colors duration-300 hover:text-primary"
              >
                Home
              </a>
            </li>
            ...
            <ul className="flex flex-col gap-4 text-center">
              ...
              <li>
                <a
                  href="#contact"
                  onClick={handleLinkClick}
                  className="inline-block w-full text-center px-6 py-2 text-white font-bold text-[0.9rem] uppercase tracking-[1px] bg-primary rounded-[5px] transition duration-300 hover:bg-primary-dark"
                >
                  Contact Us
                </a>
              </li>
