  ...
  return (
    <div className="relative h-full w-full">
      <motion.div className="text-center pt-24 px-4" style={{ opacity: titleOpacity, y: titleY }}>
        ...
        <p className="text-xl text-primary italic mt-1">It's Breaking the rules</p>
      </motion.div>
      <div className="absolute top-0 left-0 w-full h-full flex justify-center pt-48">
        <svg width="60" height="100%" viewBox="0 0 60 800" preserveAspectRatio="xMidYMin meet">
          <motion.path d="M 30 0 C -20 150, 80 250, 30 400 S -20 550, 80 650, 30 800, 30 800" fill="none" stroke="var(--color-primary)" strokeWidth="2.5" style={{ pathLength: mobilePathLength }} />
        </svg>
      </div>
      <motion.div className="absolute w-[48%] flex items-start gap-3" style={{ opacity: mobileStep1Opacity, top: '25%', left: '2%' }}>
      ...
      <motion.div className="absolute w-[48%] flex flex-row-reverse items-start gap-3" style={{ opacity: mobileStep2Opacity, top: '30%', right: '2%' }}>
      ...
      <motion.div className="absolute w-[48%] flex items-start gap-3" style={{ opacity: mobileStep3Opacity, top: '55%', left: '2%' }}>
      ...
      <motion.div className="absolute w-[48%] flex flex-row-reverse items-start gap-3" style={{ opacity: mobileStep4Opacity, top: '65%', right: '2%' }}>
