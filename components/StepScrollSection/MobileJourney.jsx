...
export default function MobileJourney({
  ...
  return (
    <div className="relative h-full w-full">
      ...
      >
        <h2 className="text-5xl landscape:text-4xl font-lora text-white">
          {t("journey.title")}
        </h2>
        <p className="text-xl landscape:text-base text-primary italic mt-1">
          {t("journey.subtitle")}
        </p>
      </motion.div>
      ...
      >
        <div className="flex-shrink-0 w-7 h-7 rounded-full border-2 border-primary flex items-center justify-center">
          <span className="text-sm font-bold text-primary">1</span>
        </div>
        <div className="text-left">
          <h3 className="text-base font-lora font-medium text-white">
            {steps[0].title.split(":")[0]}
          </h3>
          <p className="text-xs font-lato text-white/70 mt-1">
            {steps[0].description}
          </p>
        </div>
      </motion.div>
